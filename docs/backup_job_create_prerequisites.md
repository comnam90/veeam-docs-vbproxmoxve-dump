...
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/backup_job_create_prerequisites.html"
...
* By default, Veeam Plug-in for Proxmox VE [enables deduplication](https://helpcenter.veeam.com/docs/vbr/userguide/compression_deduplication.html?ver=13) for backed-up data. Due to technical limitations, you cannot disable it while configuring backup jobs.
...
* Since Veeam Backup & Replication does not allow you to assign [information about locations](https://helpcenter.veeam.com/docs/vbr/userguide/locations.html?ver=13) to the Proxmox VE server and workers, job statistics do not include information on the Proxmox VE VM data migration between different geographic regions.
