...
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/workers_add_vm.html"
...
Make sure that the default local storage is enabled on the selected host. If you cannot use the default storage in your environment, contact [Veeam Customer Support](export_logs.md).
