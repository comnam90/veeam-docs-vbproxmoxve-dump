...
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/restore_entire_vm.html"
...
5. [Select a storage where VM virtual disks will be stored](restore_entire_vm_storage.md).
6. [Specify a name for the restored VM](restore_entire_vm_name.md).
7. [Configure network settings](restore_entire_vm_network.md).
8. [Specify a restore reason](restore_entire_vm_reason.md).
9. [Verify restore settings](restore_entire_vm_summary.md).
