...
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/backup.html"
...
* [Forever Forward Incremental Backup](forever_forward_backup.md)
* [Forward Incremental Backup](forward_backup.md)
