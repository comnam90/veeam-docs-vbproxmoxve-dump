---
title: "Appendix. Configuring Multiple Networks"
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/multiple_networks.html"
...
[![Network diagram 1](images/vplugin_multiple_networks_a_b_ok2.webp)](images/vplugin_multiple_networks_a_b_ok2.webp "Network diagram 1")

Example 2. Valid Configuration

In this example, the workers, the backup server, the repository and the Proxmox VE host are connected to Network A, while the workers and the backup repository are also connected to Network B that is [configured as a preferred network](https://helpcenter.veeam.com/docs/vbr/userguide/select_backup_network.html?ver=13) to deliver traffic to the backup repository. This configuration is valid since all backup infrastructure components are connected to the same network.
...
[![Network diagram 2](images/vplugin_multiple_networks_a_b_ok.webp)](images/vplugin_multiple_networks_a_b_ok.webp "Network diagram 2")

Example 3. Valid Configuration

In this example, the workers are connected to Network A using their first vNICs and to Network B that is [configured as a preferred network](https://helpcenter.veeam.com/docs/vbr/userguide/select_backup_network.html?ver=13) to deliver traffic to the backup repository. Also, you have a router configured to forward traffic between networks A, C and D. This configuration is valid since the workers can use Network A to communicate with other backup infrastructure components though the router.
...
[![Network diagram 3](images/vplugin_multiple_networks_router.webp)](images/vplugin_multiple_networks_router.webp "Network diagram 3")
...
[![Network diagram 4](images/vplugin_multiple_networks_a_b_c.webp)](images/vplugin_multiple_networks_a_b_c.webp "Network diagram 4")
