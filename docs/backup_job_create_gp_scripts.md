...
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/backup_job_create_gp_scripts.html"
...
1. In the Windows scripts section, specify paths to pre-freeze and post-thaw scripts for Microsoft Windows VMs. For the list of supported script formats, see the Veeam Backup & Replication User Guide, section [Pre-Freeze and Post-Thaw Scripts](https://helpcenter.veeam.com/docs/vbr/userguide/pre_post_scripts.html?ver=13).
2. In the Linux scripts section, specify paths to pre-freeze and post-thaw scripts for Linux VMs. For the list of supported script formats, see the Veeam Backup & Replication User Guide, section [Pre-Freeze and Post-Thaw Scripts](https://helpcenter.veeam.com/docs/vbr/userguide/pre_post_scripts.html?ver=13).
