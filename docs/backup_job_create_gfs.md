...
product: "vbproxmoxve"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/backup_job_create_gfs.html"
...
After you configure the GFS retention policy settings, [schedule active full or synthetic full backups](backup_job_create_advanced.md). Otherwise, no new full backups will be automatically produced, and Veeam Backup & Replication will be unable to leverage them for long-term retentions.
